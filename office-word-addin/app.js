...
function handleFileSelection(file) {
  ...
  if (!file) {
    ...
    dispatchAppEvent("wnh:file-selection", { file: null });
    return;
  }
  ...
  dispatchAppEvent("wnh:file-selection", { file });
...
function clearPreviewState() {
  ...
  dispatchAppEvent("wnh:preview-cleared");
}
...
function renderPreview(preview) {
  ...
  dispatchAppEvent("wnh:preview-rendered", { preview });
}
